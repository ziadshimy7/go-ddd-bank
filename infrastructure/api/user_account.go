...
type UserAccountHandler struct {
	uas *services.UserAccountService
}

func NewUserAccountHandler(uas *services.UserAccountService) *UserAccountHandler {
	return &UserAccountHandler{uas: uas}
}

func (h *UserAccountHandler) GetUserAccountDetails(c *gin.Context) {
	...
	result, getErr := h.uas.GetUserAccountDetails(issuerInt)
